...
#include "SelfdrivingCarSimPawn.generated.h"
...
UCLASS(config=Game)
class ASelfdrivingCarSimPawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	/** Handle IncreasTheScale  */
	void OnIncreasTheScale();
	/** Handle DecreasTheScale  */
	void OnDecreasTheScale();
...
private:
	...
	void UpdateHUDStrings(float Delta);
